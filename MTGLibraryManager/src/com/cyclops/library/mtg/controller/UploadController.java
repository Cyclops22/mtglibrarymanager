...
import com.cyclops.library.mtg.domain.UploadedFile;
import com.cyclops.library.mtg.validator.FileValidator;
...
public class UploadController {
	...
	public ModelAndView fileUploaded(@ModelAttribute("uploadedFile") UploadedFile uploadedFile, BindingResult result) {
		...
		try {
			...
			File newFile = new File("D:\\dev\\workspace\\mtg library\\SpringWebFormExample\\uploaded\\" + fileName);
			if (!newFile.exists()) {
